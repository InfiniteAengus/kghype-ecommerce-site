    ...
    <li>
      ...
      >
        ...
        <InfoWrapper>
          ...
          <span>{parseInt(rand)} people pay</span>
        </InfoWrapper>
      </Card>
    </li>
  );
...
export default function ProductSearch() {
  ...
  const handleSearch = async () => {
    ...
    if (response) {
      if (response.flag === 2) {
        ...
        setTotalPage(response.data.items.pagecount);
      } else {
        history.push({
          pathname: PUBLIC_PREFIX + PRODUCT_DETAIL_PREFIX,
          state: {
  ...
  useEffect(() => {
    handleSearch();
  }, [formData.page]); //eslint-disable-line
  ...
  return (
    <Container style={ContainerStyle}>
      ...
      {loading && (
        <LoaderWrapper>
          <svg
            ...
            class='icon icon-tabler icon-tabler-loader rotate'
            width='44'
            height='44'
            viewBox='0 0 24 24'
            stroke='#408abf'
      ...
      <Pagination
        ...
        page={formData.page}
        count={totalPage}
        sx={{ mt: 6, ul: { justifyContent: 'center' } }}
          ...
          <CategoryList className='wow fadeInUp'>
            <li>
              ...
              <h1 style={{ fontSize: '15px' }}>
                Help buying online <br></br> & offline products in China
              </h1>
            </li>
            <li>
              <ImageWrapper
              ...
              <h1 style={{ fontSize: '15px' }}>
                Help you combining <br></br> items from different sellers
                <br></br> into one parcel and ship it to your home
              </h1>
            </li>
            <li>
              <ImageWrapper
              ...
              <h1 style={{ fontSize: '15px' }}>
                Efficient Service & Stable Support
              </h1>
            </li>
            <li>
              <ImageWrapper
              ...
              <h1 style={{ fontSize: '15px' }}>
                Help you solving problems <br></br> in the shortest timev
              </h1>
            </li>
          </CategoryList>
        </ShopWrapper>
